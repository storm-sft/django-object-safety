    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_ct', models.ForeignKey(limit_choices_to={'model__in': ('user', 'group')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='Content Type')),
            ],
            options={
